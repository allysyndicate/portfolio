    ...
    projects: [
      {
        ...
        descriptor: "An empirical study of short-term crypto market microstructure on Polymarket and Kalshi: six months of trade-level data, $7.8B in near-term volume, behavioral bot classification.",
      ...
      },
      {
        ...
        descriptor: "Cataloged and analyzed 593 tokenized assets across 11 asset classes ($320.6B), mapping value-creation mechanics for Pantera's quarterly tokenization report.",
      ...
      },
      {
        ...
        descriptor: "Modeled a memecoin launch as an exogenous shock in regressions on five months of hourly Base on-chain data; published in the Stanford Blockchain Review.",
      ...
      },
      {
        ...
        descriptor: "Applied Kyle-style price-impact regressions to trade-level data from 282 NFL games, comparing liquidity and price discovery on Kalshi and Polymarket.",
      ...
      },
      {
        ...
        descriptor: "Parameterized a quasi-hyperbolic discounting model of airdrop claim timing with survey-estimated user time preferences, tested against Drift's delayed-claim launch.",
      ...
      },
      {
        ...
        descriptor: "Engineered open-source on-chain and off-chain data ingestion powering a live market map of 500+ tokenized assets across nearly 300 issuing platforms.",
      ...
      },
      {
        ...
        descriptor: "Built a filing-ingestion pipeline applying regex and semantic parsing to SEC 10-Q/8-Ks, tracking holdings and valuation metrics across 30 BTC/ETH/SOL treasury companies.",
      ...
      },
      {
        ...
        descriptor: "Joined roughly 7M trades from Novig, Kalshi, and Polymarket across 282 NFL games into a dashboard with kickoff-aligned volume curves and Kyle-regression liquidity depth.",
      ...
      },
      {
        ...
        descriptor: "Measured daily tweet volume, follower-normalized engagement, and sentiment-to-token-price correlations for AI agents Truth Terminal and Luna on X.",
        href: "https://pantera-research-lab.vercel.app/",
      ...
      },
      {
        ...
        descriptor: "Surveyed 502 US crypto professionals on compensation; anonymized and normalized salary data across experience, geography, sector, and job function to compare pay by gender.",
        href: "https://pantera-research-lab.vercel.app/",
